...
{
    public class IndicatorCatList : List<commonClass.DataCategory>
    {
    ...
    public class Data
    {
                ...
                if (_sysXmlDocument == null)
                {
                    switch (commonClass.SysLibs.myAccessMode)
                    {
                        case DataAccessMode.WebService:
                            ...
                            string tmp = common.fileFuncs.ConcatFileName(common.language.myCulture.Name, commonClass.Consts.constConfFile_Meta_Indicator);
                        ...
                        default:
                            ...
                            fileName = common.fileFuncs.ConcatFileName(fileName, commonClass.Consts.constConfFile_Meta_Indicator);
                            _sysXmlDocument = new XmlDocument();
        ...
        private static IndicatorCatList _myIndicatorCatList = null;
        public static IndicatorCatList myIndicatorCatList
        {
            get
            {
                if (_myIndicatorCatList == null)
                {
                    _myIndicatorCatList = new IndicatorCatList();
    ...
    public class Helpers
    {
        ...
        protected void Init(Type indicatorType, Type indicatorFormType,string typeName,Type inputDataType)
        {
        ...
        {
            Init(indicatorType, indicatorFormType, indicatorType.Name, inputDataType);
        }
        protected void Init(Type indicatorType, Type indicatorFormType)
        {
            Init(indicatorType, indicatorFormType, indicatorType.Name, typeof(DataSeries));
        }
    }
    public class Meta
    {
    ...
    public class Libs
    {
        ...
        private static void CreateIndicatorMenu(common.DictionaryList Metas, ToolStripMenuItem toMenu, System.EventHandler ShowIndicatorHandler)
        {
            ...
            for (int idx2 = 0; idx2 < Metas.Values.Length; idx2++)
            {
                ...
                if (Data.myIndicatorCatList.Find(meta.Category.Trim()) != null) continue;
                ToolStripMenuItem menuItem = new ToolStripMenuItem();
        ...
        public static void GetUserSettings(Meta meta)
        {
            ...
            aFields.Add("output");
            aFields.Add("drawInNewWindow");
            if (!commonClass.Configuration.ReadUserSettings(commonClass.SysLibs.sysLoginCode, meta.ClassType.FullName, aFields)) return;
