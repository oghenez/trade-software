...
namespace Indicators
{
    ...
    public class KAMA : DataSeries
    {
        ...
        /// <returns></returns>
        public static KAMA Series(DataSeries ds, int period, string name)
        {
            //Build description
        ...
        /// <param name="name"></param>
        public KAMA(DataSeries db, int period, string name)
            : base(db, name)
        {
            ...
            retCode = Core.Kama(0, db.Count - 1, db.Values, period, out begin, out length, output);
