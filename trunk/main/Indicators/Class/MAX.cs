...
namespace Indicators
{
    ...
    public class MAX : DataSeries
    {
        ...
        /// <returns></returns>
        public static MAX Series(DataSeries ds, int period, string name)
        {
            //Build description
        ...
        /// <param name="name"></param>
        public MAX(DataSeries db, int period, string name)
            : base(db, name)
        {
            ...
            retCode = Core.Max(0, db.Count - 1, db.Values, period, out begin, out length, output);
