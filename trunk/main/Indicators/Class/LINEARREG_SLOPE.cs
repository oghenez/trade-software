...
namespace Indicators
{
    ...
    public class LINEARREG_SLOPE : DataSeries
    {
        ...
        /// <returns></returns>
        public static LINEARREG_SLOPE Series(DataSeries ds, int period, string name)
        {
            //Build description
        ...
        /// <param name="name"></param>
        public LINEARREG_SLOPE(DataSeries db, int period, string name)
            : base(db, name)
        {
            ...
            retCode = Core.LinearRegSlope(0, db.Count - 1, db.Values, period, out begin, out length, output);
