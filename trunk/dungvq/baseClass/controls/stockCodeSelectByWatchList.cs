...
namespace baseClass.controls
{
    ...
    public partial class stockCodeSelectByWatchList : common.control.baseUserControl
    {
        ...
        private enum watchListTypes : byte { None, All, StockExchange, WatchList, SysWatchList };
        ...
        public static void RefreshData(data.tmpDS.stockCodeDataTable dataTbl)
        {
            ...
            {
                priceRow = application.dataLibs.GetLastPrice(onTime.Date, onTime, dataTbl[idx].code);
                dataTbl[idx].price = (priceRow == null ? 0 : priceRow.closePrice);
                dataTbl[idx].priceVariant = (priceRow == null ? 0 : dataTbl[idx].price - priceRow.openPrice);
            }
        }
