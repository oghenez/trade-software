    ...
    public class Data
    {
        ...
        public static XmlDocument sysXmlDocument
        {
            get
            {
                ...
                {
                    switch (commonClass.Settings.sysAccessMode)
                    {
        ...
        private static CatList _myIndicatorCatList = null;
        public static CatList myIndicatorCatList
        {
            get
            {
                if (_myIndicatorCatList == null)
                {
                    _myIndicatorCatList = new CatList();
