    ...
    public class MarketData
    {
        ...
        public commonClass.DataSeries AdvancingIssues
        {
            get
            {
                ...
                if (dataObj == null)
                {
                    dataTbl = DataAccess.Libs.GetMarketData(this.StartDateTime, this.EndDateTime, StockCodeList, this.TimeScale, AppTypes.MarketDataTypes.Advancing);
        ...
        public commonClass.DataSeries DecliningIssues
        {
            get
            {
                ...
                if (dataObj == null)
                {
                    dataTbl = DataAccess.Libs.GetMarketData(this.StartDateTime, this.EndDateTime,StockCodeList, this.TimeScale, AppTypes.MarketDataTypes.Declining);
        ...
        public commonClass.DataSeries NonChangeIssues
        {
            get
            {
                ...
                if (dataObj == null)
                {
                    dataTbl = DataAccess.Libs.GetMarketData(this.StartDateTime, this.EndDateTime,StockCodeList, this.TimeScale, AppTypes.MarketDataTypes.NonChange);
