...
{
    public partial class tradeAlertEdit : common.control.baseUserControl
    {
        ...
        {
            codeEd.BackColor = common.settings.sysColorHiLightBG1;
            codeEd.ForeColor = common.settings.sysColorHiLightFG1;
            statusCb.LoadData();
        }
