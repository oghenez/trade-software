...
namespace baseClass.controls
{
    public partial class watchListStrategy : common.controls.baseUserControl
    {
        ...
        private databases.baseDS.portfolioDetailDataTable _myDataTbl = null;
        public databases.baseDS.portfolioDetailDataTable myDataTbl
        {
        ...
        public int test
        {
            get
            {
                return timeScaleClb.Items.Count;
            }
        }
