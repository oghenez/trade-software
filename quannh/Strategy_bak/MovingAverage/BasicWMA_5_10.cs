...
namespace strategy
{
    public class BasicWMA_5_10 : GenericStrategy
    {
        public BasicWMA_5_10(analysis.workData d, string code, bool fExport, string curStrategy) : base(d, code, fExport, curStrategy) { }
        public override analysis.analysisResult Execute()
        {
            double[] line1 = data.WMA(5);
            double[] line2 = data.WMA(10);
