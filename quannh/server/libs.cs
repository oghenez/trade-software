...
namespace server
{
    public partial class libs
    {
        ...
        public static bool AllowToUpdate(DateTime curDateTime)
        {
            ...
            bool saveEncryption = application.configuration.withEncryption;
        ...
        public static void FetchRealTimeData()
        {
            ...
            while (true)
            {
                ...
                common.fileFuncs.WriteLog(DateTime.Now.ToString() + " : update data from " + aFields[0] + " " + aFields[1]);
                imports.libs.ImportPricedata_URL(aFields[0], aFields[1]);
                idx++;
            }
            return;
        }
