...
namespace wsServices
{
    ...
    public interface IStockService
    {
        ...
        [OperationContract]
        List<decimal[]> Estimate_Matrix_Profit(application.AppTypes.TimeRanges timeRange, string timeScaleCode,
                                               string[] stockCodeList, string[] strategyList,
                                               application.wsData.EstimateOptions option);
        
        [OperationContract]
        List<double[]> Estimate_Matrix_LastBizWeight(application.AppTypes.TimeRanges timeRange, string timeScaleCode,
                                                     string[] stockCodeList, string[] strategyList);
