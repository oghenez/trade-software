...
namespace ProvisionServer {
    ...
    public partial class ProductDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public ProductsRow AddProductsRow(int ID, string Name, decimal ListPrice) {
...
namespace ProvisionServer.ProductDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([ListPrice] = @Original_ListPrice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ID], [Name], [ListPrice]) VALUES (@ID, @Name, @Lis" +
                "tPrice);\r\nSELECT ID, Name, ListPrice FROM Products WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ID] = @ID, [Name] = @Name, [ListPrice] = @ListPrice " +
                "WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([ListPrice] = @O" +
                "riginal_ListPrice));\r\nSELECT ID, Name, ListPrice FROM Products WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProvisionServer.Properties.Settings.Default.SyncDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, ListPrice FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, decimal Original_ListPrice) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_ListPrice));
        ...
        public virtual int Insert(int ID, string Name, decimal ListPrice) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(ListPrice));
        ...
        public virtual int Update(int ID, string Name, decimal ListPrice, int Original_ID, string Original_Name, decimal Original_ListPrice) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(ListPrice));
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((decimal)(Original_ListPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal ListPrice, int Original_ID, string Original_Name, decimal Original_ListPrice) {
            return this.Update(Original_ID, Name, ListPrice, Original_ID, Original_Name, Original_ListPrice);
        }
    }
