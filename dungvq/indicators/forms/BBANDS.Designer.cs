namespace Indicators.forms
{
    partial class BBANDS
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.upperLbl = new baseClass.controls.baseLabel();
            this.lowerLbl = new baseClass.controls.baseLabel();
            this.kDownEd = new common.control.numberTextBox();
            this.middleLbl = new baseClass.controls.baseLabel();
        ...
        protected baseClass.controls.baseLabel upperLbl;
        protected baseClass.controls.baseLabel lowerLbl;
        protected common.control.numberTextBox kDownEd;
        protected baseClass.controls.baseLabel middleLbl;
