...
namespace Indicators
{
    ...
    public class Bop : DataSeries
    {
        ...
        public static Bop Series(DataBars ds, string name)
        {
            ...
            if (ds.Cache.ContainsKey(description)) return (Bop)ds.Cache[description];

            //Create Bop, cache it, return it
            Bop bop = new Bop(ds, description);
            ds.Cache[description] = bop;
            return bop;
        }
