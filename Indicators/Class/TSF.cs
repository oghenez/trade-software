...
namespace Indicators
{
    ...
    public class TSF : DataSeries
    {
        ...
        /// <returns></returns>
        public static TSF Series(DataSeries ds, double period, string name)
        {
            //Build description
        ...
        /// <param name="name"></param>
        public TSF(DataSeries db, double period, string name)
            : base(db, name)
        {
            ...
            retCode = Core.Tsf(0, db.Count - 1, db.Values, (int)period, out begin, out length, output);
