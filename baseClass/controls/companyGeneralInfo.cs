...
namespace baseClass.controls
{
    public partial class companyGeneralInfo : common.controls.baseUserControl
    {
        ...
        public override void SetLanguage()
        {
            ...
            enNameLbl.Text = Languages.Libs.GetString("name") + "(English)";
            addressLbl1.Text = Languages.Libs.GetString("address") + " 1";
            addressLbl2.Text = Languages.Libs.GetString("address") + " 2";
            nationLbl.Text = Languages.Libs.GetString("nationality");
            phoneLbl.Text = Languages.Libs.GetString("phone");
            websiteLbl.Text = Languages.Libs.GetString("website");
        }
